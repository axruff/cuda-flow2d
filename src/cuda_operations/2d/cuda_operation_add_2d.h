...
#ifndef GPUFLOW3D_CUDA_OPERATIONS_2D_CUDA_OPERATION_ADD_H_
#define GPUFLOW3D_CUDA_OPERATIONS_2D_CUDA_OPERATION_ADD_H_
...
class CudaOperationAdd2D : public CudaOperationBase {
private:
  CUfunction cuf_add_;
...
#endif // !GPUFLOW3D_CUDA_OPERATIONS_2D_CUDA_OPERATION_ADD_H_
