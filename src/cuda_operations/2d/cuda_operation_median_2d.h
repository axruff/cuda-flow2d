...
#ifndef GPUFLOW3D_CUDA_OPERATIONS_2D_CUDA_OPERATION_MEDIAN_H_
#define GPUFLOW3D_CUDA_OPERATIONS_2D_CUDA_OPERATION_MEDIAN_H_
...
class CudaOperationMedian2D : public CudaOperationBase {
private:
