...
#ifndef GPUFLOW3D_CUDA_OPERATIONS_2D_CUDA_OPERATION_REGISTRATION_H_
#define GPUFLOW3D_CUDA_OPERATIONS_2D_CUDA_OPERATION_REGISTRATION_H_

#include <cuda.h>

#include "src/cuda_operations/cuda_operation_base.h"

class CudaOperationRegistration2D : public CudaOperationBase {
private:
...
#endif // !GPUFLOW3D_CUDA_OPERATIONS_2D_CUDA_OPERATION_REGISTRATION_H_
